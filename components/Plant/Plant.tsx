...
import { Body, Header, Image, Wrapper, Container, ItemsWrapper, SmallImage } from "./Plant.styles";
...
const Plant = ({ name, imgSrc }: PlantProps) => {
  ...
  return (
    <Container>
      <Wrapper>
      <TouchableHighlight onLongPress={onLongPress} underlayColor="white" style={{width: "100%", height: "100%"}}>
